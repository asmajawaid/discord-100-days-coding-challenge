...
console.log("Inequality test with string: ", ('apple' as string) != 'orange'); //true
...
console.log("inequality test with number:", (26 as number) != 36); // true (inequality)
...
const fruits : string[] = ["apple", "banana", "mango", "orange", "peach"]; //true
